...
class AY38912:
    """AY-3-8912 PSG core with register logic, ports and PCM rendering."""

    clock_hz: int = 1_000_000
    sample_rate: int = 44_100
    port_a_read: object = None
    port_a_write: object = None
    port_b_read: object = None
    port_b_write: object = None
    ...
    def _mix_output(self) -> int:
        ...
        return int((total / (3 * self.LEVEL_TABLE[15])) * 32767.0)
